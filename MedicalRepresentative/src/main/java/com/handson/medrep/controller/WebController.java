...
import com.handson.medrep.controller.MedrepRepository;
...
public class WebController {
    ...
    @GetMapping("/get")
    public MedrepModel getMethod(@RequestParam("ID") String ID) {
    ...
    @PutMapping("/put/{ID}")
    public MedrepModel putMethod(@PathVariable String ID, @RequestBody MedrepModel medrep) {
